...
this means information has been exchanged between two threads. That single,
innocent line of code elegantly handles every synchronization conflict that
could ever occur, liberating us from race conditions once for all!
